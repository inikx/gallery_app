...
/// @nodoc
class __$$_ApiImageCopyWithImpl<$Res>
    extends _$ApiImageCopyWithImpl<$Res, _$_ApiImage>
...
class _$_ApiImage implements _ApiImage {
  const _$_ApiImage({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'ApiImage(id: $id, name: $name)';
  }
...
abstract class _ApiImage implements ApiImage {
  const factory _ApiImage({required final int id, required final String name}) =
      _$_ApiImage;
